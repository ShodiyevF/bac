const { companysGETCTRL, companyPOSTCTRL, companyOwnerGETCtrl, companyWorkersGETCTRL, companysWorkersPermissionGETCTRL, companysWorkersPermissionPOSTCTRL, superAdminUsersGETCTRL, masterPostCTRL, WorkersCompanyPUTCTRL, userDeleteCTRL } = require('./ctrl')
...
express.put('/companys/workers/put', (req, res) => WorkersCompanyPUTCTRL(req, res))
express.post('/companys/workers/add', (req, res) => masterPostCTRL(req, res))
express.delete('/companys/workers/delete', (req, res) => userDeleteCTRL(req, res))
